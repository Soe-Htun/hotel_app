        ...
        <b-navbar fixed="top" toggleable="lg" type="dark" variant="dark">
            ...
            <!-- ALignment right -->
                <b-navbar-nav class="ml-auto">
                    <b-nav-form >
                        <b-button @click="modaldata2('Check Reservation','success')"
                        size="sm" class="my-2 mr-2 my-sm-0">
                            <i class="fas fa-door-open"></i> Check Reservation
                        </b-button>
                        <b-button @click="modaldata2('Cancel Reservation','danger')"
                        size="sm" class="my-2 mr-2 my-sm-0">
                            <i class="fas fa-window-close"></i> Cancel Reservation
                        </b-button>
                        <b-button @click="modaldata2('Contact','primary')"
                        size="sm" class="my-2 mr-2 my-sm-0">
                            <i class="fas fa-phone"></i> Contact
                        </b-button>
                        <b-button @click="modaldata2('Administrator', 'dark')"
                        size="sm" class="my-2 mr-2 my-sm-0">
